  ...
  return (
    ...
    >
      <Link
        ...
        className="px-4 py-2 hover:text-[#3C73DA] hover:scale-110 flex justify-between items-center"
      >
        {service.label}
        {service.subItems && <span className="ml-2">&raquo;</span>}
      </Link>
...
export default function Navbar() {
      ...
      <div className="flex  mr-10">
        <div className="flex  mr-16 justify-between gap-16 ">
          ...
          >
            ...
            {isServiceCard && (
              <div className="absolute left-0 mt-2 py-2 w-56 rounded-md shadow-lg bg-white text-black flex flex-col gap-1">
                {servicesData.services.map((service) => (
  ...
  return screens.xl ? renderDesktopNav() : <MobileNavbar />;
}
