...
const ContactForm = () => {
  ...
  const sendEmail = (e: React.FormEvent) => {
    ...
    emailjs
      ...
      .then(() => {
        setAlertMessage('Your message has been sent successfully!'); // Set the alert message
        setSuccess(true); //  set success to true, although we are using alertMessage for conditional render
        setName("");
        setEmail("");
        setPhone("");
        setMessage("");
    ...
    <div className="bg-gray-200 min-h-screen text-blue-400 py-10 w-full flex justify-center">
      <div className="w-full max-w-5xl bg-gray-900 p-6 rounded-lg shadow-lg">
        ...
        <div className="flex flex-col md:flex-row gap-12 mt-10">
          {/* Left column with map and contact box */}
